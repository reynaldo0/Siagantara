      ...
      <div className="flex flex-col">
        ...
        <div className="map mt-16 md:mt-auto md:flex-1 z-10">
          {isMapVisible ? (
            ...
            <ReactSVG
              src={mapImage}
              className="indonesia scale-50 md:scale-100 max-w-[300px] items-center max-h-[80vh] md:max-w-full h-auto w-full object-contain"
        ...
        <div className="mt-16 md:mr-12">
          <div className="flex justify-between items-center px-6 py-4 border-b">
            <div className="flex items-center cursor-pointer" onClick={toggleStatus}>
