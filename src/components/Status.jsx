...
const StatusSection = ({ isHidden }) => {
  const statuses = [
    ...
    },
    {
      ...
      shortLabel: "Evakuasi",
      icon: "/icons/posko.svg",
    },
    {
      label: "Kantor Layanan Darurat",
      shortLabel: "Layanan",
      icon: "/icons/layanan.svg",
    },
    ...
    { label: "Titik Rawan", shortLabel: "Rawan", icon: "/icons/rawan.svg" },
    {
      label: "Titik Bencana",
      shortLabel: "Bencana",
      icon: "/icons/bencana.svg",
    },
    {
      label: "Jalur Evakuasi",
      shortLabel: "Jalur",
      icon: "/icons/evakuasi.svg",
    },
  ];
  ...
  return (
    <div className="px-5 md:px-7">
      <div className="flex flex-wrap items-center space-x-7 md:space-x-10 space-y-2 pb-3 border-b-2 border-b-[#1E3A5F]">
        {isHidden ? (
          <p className="text-gray-500 text-left w-full inline ">
            --------------------------------------------------------------------------------------------------------
